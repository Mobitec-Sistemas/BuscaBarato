...
<form class="form-horizontal" action="<c:url value="/empresa/cadastro"/>" method="POST">
    ...
    <mt:campoTexto type="text" id="cidade" label="Cidade:" name="empresa.bairro.cidade.nome" value="${empresa.bairro.cidade.nome}" placeholder="Cidade da Empresa" />
    
    <mt:campoTexto type="text" id="estado" label="Estado:" name="empresa.bairro.cidade.estado.nome" value="${empresa.bairro.cidade.estado.nome}" placeholder="Estado da Empresa" />    
