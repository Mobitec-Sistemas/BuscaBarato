...
<html ng-app="MyApp">
    <head>
        ...
        <meta name="description" content="Buscador de PreÃ§os">
    ...
    <body ng-controller="MyController">
        <div class="container">
            ...
            <form class="form-signin" action="${linkTo[UsuarioController].login}" method="POST" ng-submit="enviarForm()">
                ...
                <input type="text" id="inputUsuario" name="usuario.login" class="form-control" placeholder="UsuÃ¡rio" required autofocus ng-model="login" >
        ...
        <!-- Carrega o usuÃ¡rio e senha do Cook -->
